<footer class="footer">
    <div class="footer__inner">
        ...
        <p class="footer__comment">当店は、隣接する<a href="#">かなまる歯科クリニック</a>と連携をしています。</p>
        <div class="footer__box">
            <div class="footer__box-inner">
                <div class="footer__wrap">
                    <div class="footer_logo">
                        <p class="footer__logo-item"><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/header_logo.jpg" alt="ロゴ"></a></p>
                    </div>
